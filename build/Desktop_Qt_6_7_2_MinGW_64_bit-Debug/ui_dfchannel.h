...
public:
    ...
    void setupUi(QWidget *DFChannel)
    {
        ...
        DFChannel->resize(1058, 903);
        frame = new QFrame(DFChannel);
        frame->setObjectName("frame");
        frame->setGeometry(QRect(-21, 75, 1081, 831));
...
"}"));
        ...
        frame_2->setGeometry(QRect(20, 0, 1061, 831));
...
"}"));
        ...
        pushButton_4->setGeometry(QRect(930, 710, 131, 111));
...
"}"));
        ...
        customplot_4->setGeometry(QRect(20, 220, 301, 141));
...
"}"));
        ...
        customplot_7->setGeometry(QRect(20, 390, 301, 141));
...
"}"));
        ...
        customplot_8->setGeometry(QRect(620, 590, 301, 141));
...
"}"));
        ...
        customplot_5->setGeometry(QRect(740, 390, 301, 141));
...
"}"));
        ...
        customplot_3->setGeometry(QRect(740, 220, 301, 141));

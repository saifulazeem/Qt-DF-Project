...
public:
    ...
    void setupUi(QMainWindow *df_gui_version_1)
    {
        ...
        df_gui_version_1->resize(1055, 780);
...
"}"));
        ...
        frame->setGeometry(QRect(700, 80, 361, 651));
...
"}"));
        ...
        groupBox_11->setGeometry(QRect(10, 440, 681, 291));
...
"\n"
"}"));
        customplot_2 = new QCustomPlot(groupBox_11);
        customplot_2->setObjectName("customplot_2");
        customplot_2->setGeometry(QRect(190, 10, 281, 271));
